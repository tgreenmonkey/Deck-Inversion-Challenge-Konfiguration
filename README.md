...
* There are a few times where I injected something that hijacked the functionality of the game, and therefore in running this mod with other mods, expect some weird functionality on some things relating to scoring, unlocks, or pack items at times
...
- If you like DICK, you'll LOVE [ASS](https://github.com/developerrowan/AmplifiedScreenShake) by [@DeveloperRowan](https://github.com/developerrowan)
