...
* There are a few times where I injected something that hyjacked the functionality of the game, and therefore in running this mod with other mods, expect some wierd functionality on some things relating to scoring, unlocks, or pack items at times
