...
* There are likely to be some issues with text not showing up (specifically on the locked decks) due to me writing this in a bad way without some of the proper precausions taken, and this issue will be fixed in a future patch
* There are a few times where I injected something that hyjacked the functionality of the game, and therefore in running this mod with other mods, expect some wierd functionality relating to scoring, unlocks, or pack items at times
...
[@AdamBennett](https://github.com/adambennett) : Creator of the Custom Deck Creation Tool. I used your inversed assets for the decks! A few creative ideas were sparked by your [Deck Creator](https://github.com/adambennett/Balatro-DeckCreator) mod so thank you very much for your mod please go check it out!
...
![Locked Image 1](screenshots/locked1.png)
![Locked Image 2](screenshots/locked2.png)
